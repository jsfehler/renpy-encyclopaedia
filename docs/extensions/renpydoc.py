...
class PythonIndex(sphinx.domains.Index):
    """An index class for generating a Function and Class Index for the PythonDomain.

    This class generates a Function and Class Index for the PythonDomain, which
    includes all the functions and classes defined in the documentation.

    Attributes:
        name (str): The name of the index.
        localname (str): The local name of the index.
        shortname (str): The short name of the index.
    """
    ...
    def generate(self, docnames: Optional[Sequence[str]] = None):
